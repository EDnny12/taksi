...
class MisViajes extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<QuerySnapshot>(
      stream: Firestore.instance
          .collection("viajes").orderBy(ordenar,descending: true)
  ...
  Widget lista(List<DocumentSnapshot> document, BuildContext context) {
    return document.length!=0? ListView.separated(
            ...
            child: Column(
              children: <Widget>[
                ...
                Row(
                 ...
                 RaisedButton(child:Text(inicio) ,shape: StadiumBorder(),onPressed: (){},animationDuration: Duration(seconds: 0),
                   splashColor: Colors.transparent,
                   highlightColor: Colors.transparent,
                 ),
                  RaisedButton(child: Text(destino),shape: StadiumBorder(),onPressed: (){},animationDuration: Duration(seconds: 0),
          splashColor: Colors.transparent,
          highlightColor: Colors.transparent, //
           ),
                  ],
